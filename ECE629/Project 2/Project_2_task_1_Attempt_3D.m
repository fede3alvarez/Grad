...
% Covariance
Sigma=[0.075 0.075 0.075];

A1=mvnrnd([0,0,1],Sigma,s);
A2=mvnrnd([1,1,1],Sigma,s);
B1=mvnrnd([0,1,0],Sigma,s);
B2=mvnrnd([1,0,0],Sigma,s);
...
figure(i_fig)
plot3(A(1,:),A(2,:),A(3,:),'dk','MarkerFaceColor','black'),
hold on
plot3(B(1,:),B(2,:),B(3,:),'sb','MarkerFaceColor','blue'),
grid on
...
plot_db_3d(l1_lr_med,val_min, val_max,step,val_min, val_max,step,val_min, val_max,step)
hold on
plot3(A(1,:),A(2,:),A(3,:),'dk','MarkerFaceColor','black'),
hold on
plot3(B(1,:),B(2,:),B(3,:),'sb','MarkerFaceColor','blue'),
